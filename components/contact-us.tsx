...
export function ContactUs() {
  // Redirect to home page and scroll to CTA section
  const redirectToHomePageCTA = () => {
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <motion.h1
            ...
            className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl text-gray-900 text-center"
          >
